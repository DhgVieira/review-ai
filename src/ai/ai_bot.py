...
class AiBot(ABC):
    ...
    __problems="errors, issues, vulnerabilities, potential crashes or unhandled exceptions"
    __chat_gpt_ask_long="""
Could you describe briefly {problems} for the next code with given git diffs? 
Please, also, do not add intro words, just print errors in the format: "line_number get line number starting with the (-) or (+) : cause effect"
